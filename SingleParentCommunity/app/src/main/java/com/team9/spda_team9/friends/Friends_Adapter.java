...
import com.team9.spda_team9.forum.Category;
import com.team9.spda_team9.forum.Subscription;
...
public class Friends_Adapter extends FirestoreRecyclerAdapter<User, Friends_Adapter.UserViewHolder> {

    private Friends_Adapter.OnListItemClick onListItemClick;
    private FirebaseFirestore DB = FirebaseFirestore.getInstance();
    private String userId;
    private User user;
    private String TAG = Friends_Adapter.class.getSimpleName();

    private String friendID;

    public Friends_Adapter(@NonNull FirestoreRecyclerOptions<User> options, Friends_Adapter.OnListItemClick onListItemClick) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull Friends_Adapter.UserViewHolder holder, int position, @NonNull User model) {
    ...
    @NonNull
    @Override
    public Friends_Adapter.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
