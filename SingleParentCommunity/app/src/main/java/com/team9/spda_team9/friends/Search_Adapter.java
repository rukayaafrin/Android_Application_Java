...
public class Search_Adapter extends FirestoreRecyclerAdapter<User, Search_Adapter.UserViewHolder> {
    private OnListItemClick onListItemClick;
    private FirebaseFirestore DB = FirebaseFirestore.getInstance();
    private String userId;
    private User user;
    private String TAG = Search_Adapter.class.getSimpleName();

    private String friendID;

    public Search_Adapter(@NonNull FirestoreRecyclerOptions<User> options, OnListItemClick onListItemClick) {
        super(options);
